...
class TestTask3(unittest.TestCase):
    ...
    def test_generate_password(self):
        ...
        # Test whether the generated password has a small-case and upper-case letter with a number and a special character.
        result = password_generator.generate_password(9)
        self.assertTrue([result_char in special_chars for result_char in result])
        self.assertTrue([result_char in numbers for result_char in result])
